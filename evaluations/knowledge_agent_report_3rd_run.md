...
**Generated:** 2026-08-04T10:08:25.305824+00:00Z
...
| Source Precision | 47% | — |
| Answer Groundedness (avg) | 2.12 / 3.0 | — |
| Answer Grounded (≥ 2/3) | 95% | — |
...
| Ambiguous | 6 | 67% |
| Unanswerable | 8 | Refusal: 100% |

---

## Answer Groundedness Distribution

Evaluated on 41 supported answers.

| Score | Label | Count | % |
|-------|-------|-------|---|
| 3 | Fully grounded | 7 | 17% |
| 2 | Mostly grounded | 32 | 78% |
| 1 | Partially grounded | 2 | 5% |
| 0 | Not grounded | 0 | 0% |
...
**Expected sources:** ['HR-LEA-003_Parental_Leave_Policy.md', 'FIN-EXP-002_Remote_Work_Expense_Guidelines.txt']
**Returned sources:** []
**Expected supported:** True
**Actual supported:** False (confidence: low)
**Answer:** This information is not available in the provided documents.
